...
import com.olele76.paintingandstatue.R
import com.olele76.paintingandstatue.databinding.ItemLayoutBinding

class ListArtAdapter(var items: ArrayList<Art>) :
    ...
    fun updateData(items: ArrayList<Art>){
        this.items = items
